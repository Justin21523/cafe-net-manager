...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/cafe-net-manager",
  ...
  "features": [
    ...
    "Seat state, timed billing, orders, carts, kitchen boards, and checkout workflows are handled inside one local system"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: C++, Qt, SQLite, CMake, Qt Widgets,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "I built a multi-tab Qt Widgets desktop interface backed by a SQLite repository layer and service layer",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "Seat state, timed billing, orders, carts, kitchen boards, and checkout workflows are handled inside one local system",
      "status": "Queued",
      "owner": "Automation"
    }
  ]
